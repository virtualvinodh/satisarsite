...
// name: 'ComponentName',
  data () {
    return {
      vowelsB: '𑆃 𑆄 𑆅 𑆆 𑆇 𑆈 𑆉 𑆊 𑆋 𑆌 𑆍 𑆎 𑆏 𑆐 𑆃𑆁 𑆃𑆂 𑆃𑆀 𑆃᳐ 𑆄᳐ 𑆃᳘ 𑆃᳕ 𑆍ᳮ 𑆃ᳯ'.split(' '),
      vowelsT: 'अ आ इ ई उ ऊ ऋ ॠ ऌ ॡ ए ऐ ओ औ अं अः अँ ॳ ॴ ॶ ॷ ऎ ऒ'.split(' '),
      vowelsR: 'a ā i ī u ū ṛ ṝ ḷ ḹ e ai o au aṃ aḥ am̐ ö ȫ ü ǖ ĕ ŏ'.split(' '),
      consonantsB: '𑆑 𑆒 𑆓 𑆔 𑆕 𑆖 𑆗 𑆘 𑆙 𑆚 𑆛 𑆜 𑆝 𑆞 𑆟 𑆠 𑆡 𑆢 𑆣 𑆤 𑆥 𑆦 𑆧 𑆨 𑆩 𑆪 𑆫 𑆬 𑆭 𑆮 𑆯 𑆰 𑆱 𑆲 𑆖𑇊 𑆗𑇊 𑆘𑇊'.split(' '),
      consonantsT: 'क ख ग घ ङ च छ ज झ ञ ट ठ ड ढ ण त थ द ध न प फ ब भ म य र ल ळ व श ष स ह च़ छ़ ज़'.split(' '),
      consonantsR: 'k& kh& g& gh& ṅ& c& ch& j& jh& ñ& ṭ& ṭh& ḍ& ḍh& ṇ& t& th& d& dh& n& p& ph& b& bh& m& y& r& l& l̤& v& ś& ṣ& s& h& c̈& c̈h& z&'.split(' '),
      vowelSignsB: '𑆳 𑆴 𑆵 𑆶 𑆷 𑆸 𑆹 𑆺 𑆻 𑆼 𑆽 𑆾 𑆿 𑇀 𑆁 𑆂 𑆀 ᳐ 𑆳᳐ ᳘ ᳕ ᳮ ᳯ'.split(' '),
      vowelSignsT: 'ा ि ी ु ू ृ ॄ ॢ ॣ े ै ो ौ ् ं ः ँ ऺ ऻ ॖ ॗ ॆ ॊ'.split(' '),
      vowelSignsR: 'ā i ī u ū ṛ ṝ ḷ ḹ e ai o au x $ṃ $ḥ $m̐ ö ȫ ü ǖ ĕ ŏ'.split(' '),
      ...
      vowelSignska: ' ऺ ऻ ॖ ॗ ॆ ॊ'.trim().split(' '),
      ...
      sampleCompound: 'खा खि खी खु खू खृ खॄ खॢ खॣ खे खै खो खौ खं खः खँ खऺ खऻ खॖ खॗ खॆ खॊ'.split(' '),
