...
<script>
import {openURL, QEditor, QRadio, QBtn, QField, QBtnToggle, QToggle, QSlider, QTooltip, QInput} from 'quasar'
  ...
  methods: {
    ...
    convertText: function (text) {
      if (this.inputScript === 'devanagari') {
        return this.convertDS(this.sanitize(text))
      } else {
        return this.convertRDS(Sanscript.t(this.sanitize(text), this.inputScript, 'sharada'))
      }
    },
    ...
    printDocument: function () {
      ...
      pdfMake.fonts = {
        Roboto: {
          normal: 'https://cdn.jsdelivr.net/gh/virtualvinodh/satisarsharada/Sharada.ttf',
          bold: 'https://cdn.jsdelivr.net/gh/virtualvinodh/satisarsharada/Sharada.ttf',
          italics: 'https://cdn.jsdelivr.net/gh/virtualvinodh/satisarsharada/Sharada.ttf'
        }
      }
